...
hl.data.out_location <- "hs9_imp.1.out"   ############################3

output_file <- "ProTurn_Output_hs9_imp1.txt"  ######################################
...
new_oupt <- read.table("ProTurn_Output_hs9_imp1.txt", header=TRUE, fill=TRUE, skip = 0)  #################3
...
imp1 <- read.table("ProTurn_Output_hs9_imp1.txt", header=TRUE, fill=TRUE, skip = 0)
...
imp2 <- read.table("ProTurn_Output_hs9_imp2.txt", header=TRUE, fill=TRUE, skip = 0)
dat_imp<-imp2
newdata_imp <- subset(dat_imp, R2 >= 0.8 | SS<0.05 )
#newdata_imp <- subset(dat_imp)
...
imp3 <- read.table("ProTurn_Output_hs9_imp3.txt", header=TRUE, fill=TRUE, skip = 0)
dat_imp<-imp3
newdata_imp <- subset(dat_imp, R2 >= 0.8 | SS<0.05   )
#newdata_imp <- subset(dat_imp)
...
imp4 <- read.table("ProTurn_Output_hs9_imp4.txt", header=TRUE, fill=TRUE, skip = 0)
dat_imp<-imp4
newdata_imp <- subset(dat_imp, R2 >= 0.8 | SS<0.05 )
#newdata_imp <- subset(dat_imp)
...
imp5 <- read.table("ProTurn_Output_hs9_imp5.txt", header=TRUE, fill=TRUE, skip = 0)
dat_imp<-imp5
newdata_imp <- subset(dat_imp, R2 >= 0.8 | SS<0.05 )
#newdata_imp <- subset(dat_imp)
...
imp6 <- read.table("ProTurn_Output_hs9_imp6.txt", header=TRUE, fill=TRUE, skip = 0)
dat_imp<-imp6
newdata_imp <- subset(dat_imp, R2 >= 0.8 | SS<0.05 )
#newdata_imp <- subset(dat_imp)
...
imp7 <- read.table("ProTurn_Output_hs9_imp7.txt", header=TRUE, fill=TRUE, skip = 0)
dat_imp<-imp7
newdata_imp <- subset(dat_imp, R2 >= 0.8 | SS<0.05 )
#newdata_imp <- subset(dat_imp)
...
imp8 <- read.table("ProTurn_Output_hs9_imp8.txt", header=TRUE, fill=TRUE, skip = 0)
dat_imp<-imp8
newdata_imp <- subset(dat_imp, R2 >= 0.8 | SS<0.05 )
#newdata_imp <- subset(dat_imp)
...
imp9 <- read.table("ProTurn_Output_hs9_imp9.txt", header=TRUE, fill=TRUE, skip = 0)
dat_imp<-imp9
newdata_imp <- subset(dat_imp, R2 >= 0.8| SS<0.05  )
#newdata_imp <- subset(dat_imp)
...
imp10 <- read.table("ProTurn_Output_hs9_imp10.txt", header=TRUE, fill=TRUE, skip = 0)
dat_imp<-imp10
newdata_imp <- subset(dat_imp, R2 >= 0.8 | SS<0.05 )
#newdata_imp <- subset(dat_imp)
...
write.csv(median_hl_impT,"hs9_kwithImp_filtered.csv")
